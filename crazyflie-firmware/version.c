...
const char * V_SLOCAL_REVISION="5+";
const char * V_SREVISION="bbae9a9a5858";
const char * V_STAG="2014.01.0";
const char * V_BRANCH="(detached from bbae9a9)
  master";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=false;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0xbbae9a9a;
const uint16_t V_REVISION_1=0x5858;
